...
::: tip Flight Deck
You can also monitor all active bots from the **Flight Deck**. Click the **Flight Deck** button in the top-right corner, or press `Ctrl+Shift+F`, for a global view of every running agent and workflow. See the [No-Code Guide](/guides/no-code-guide#the-flight-deck) for details.
:::
